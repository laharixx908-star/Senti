...
const feedbackMap: Record<string, string> = {
  ...
  Relieved:    "That weight off your shoulders is well deserved.",
  Hopeful:     "Holding onto hope takes strength. Keep looking forward.",
  Nostalgic:   "Those memories clearly meant a lot. Cherish them.",
  ...
  Sleepy:      "Your body is telling you it needs rest — listen to it.",
  Exhausted:   "You've been pushing hard. It's okay to stop and recharge.",
  ...
  Frustrated:  "That kind of friction wears you down. It's okay to step back.",
  Jealous:     "Those feelings are human. Use them to understand what you truly want.",
};
