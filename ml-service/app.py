...
if not os.path.exists(MODEL_PATH):
    gdown.download("https://drive.google.com/uc?id=1dU2hW-ym402VFkhJ-_Dz2l49llE5-6Un", MODEL_PATH, quiet=False)

if not os.path.exists(LE_PATH):
    gdown.download("https://drive.google.com/uc?id=13BcuF5SEdXAIdML7DMMGm0pRWPaD5iGd", LE_PATH, quiet=False)
